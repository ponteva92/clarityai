...
export function Contact() {
  usePageMeta({
    title: 'Yhteystiedot — varaa ilmainen AI-kartoitus',
    description: 'Varaa ilmainen 30 minuutin tekoälykartoitus tai lähetä viesti. Vastaan jokaiseen yhteydenottoon 24 tunnin sisällä. Oulu + koko Suomi etänä.',
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error('Viestin lähetys epäonnistui. Yritä myöhemmin uudelleen.');
      }
    } catch (error) {
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <option value="chatbots">Älykkäät Chatbotit</option>
                      <option value="courses">Tekoälykoulutukset</option>
                      <option value="automation">Älykäs Prosessiautomaatio</option>
                      <option value="dev">AI-Sovellus- & Verkkokehitys</option>
