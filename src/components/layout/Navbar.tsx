      ...
      <div className="container mx-auto px-6 md:px-12 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <button
            ...
            className="ml-4 px-5 py-2.5 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 transition-all duration-300 text-sm font-medium flex items-center gap-2 group"
          >
